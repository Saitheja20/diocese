        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                $primaryschools = [
                    ...
                    //     'name' => 'APPANNAPET',
                    //     'year' => '1970',
                    //     'image' => 'assets/images/church/appannapet.jpg',
                ...
                <div class="card mb-4" data-aos="fade-up"
                    ...
                    <div class="row no-gutters align-items-stretch" id="schoolCard">
                        ...
                        <div class="col-lg-4 col-md-12 transition-col" id="imageCol">
                            <img src="<?= base_url('assets/parish.jpeg') ?>" class="img-fluid h-100 w-100" alt="Parish church" style="object-fit: cover;">
                        </div>
                ...
                <div class="card mb-4" data-aos="fade-up"
                    ...
                    <div class="row no-gutters align-items-stretch" id="schoolCard">
                        ...
                        <div class="col-lg-4 col-md-12 transition-col" id="imageCol">
                            <img src="<?= base_url('assets/images/education/BISHOP-BERETTA-E_M-HIGHS-CHOOL.jpg') ?>"
                                class="img-fluid h-100 w-100" alt="Parish church" style="object-fit: cover;">
                        </div>
                ...
                <div class="card mb-4" data-aos="fade-up"
                    ...
                    <div class="row no-gutters align-items-stretch" id="schoolCard">
                        <!-- Image Side -->
                        <div class="col-lg-4 col-md-12 transition-col" id="imageCol">
                            <img src="<?= base_url('assets/parish.jpeg') ?>"
                                class="img-fluid h-100 w-100" alt="Parish church" style="object-fit: cover;">
                        </div>
