                ...
                <div id="carouselExampleRide" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= base_url('assets/images/banners/banner4.png') ?>" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url('assets/images/banners/banner5.png') ?>" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url('assets/images/banners/banner2.png') ?>" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="<?= base_url('assets/images/banners/banner1.png') ?>" class="d-block w-100" alt="...">
                        </div>
                    </div>
        ...
        <div class="col-lg-5 col-md-12 col-12 mb-4 mt-4" data-aos="fade-right" data-aos-duration="3000">
            <div class="card shadow border-0 h-100 bishop-card">
                <div class="card-body text-center">
                    <img src="<?= base_url('assets/images/churchimage.png') ?>"
...
<section class="py-5 bg-light">
    <div class="container"
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-center">
                <img src="<?= base_url('assets/images/bishops/vijay-paul-reddy.JPG') ?>" alt="Msgr Thomas D'Souza"
                    class="img-fluid rounded shadow"
                    style="max-height: 400px; object-fit: cover;">
            </div>
        </div>
