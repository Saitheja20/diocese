                ...
                <div class="tab-content" id="academicTabContent">
                    ...
                    <div class="tab-pane fade show active" id="polytechnic" role="tabpanel" aria-labelledby="polytechnic-tab">
                        ...
                        $primaryschools = [
                            [
                                ...
                                'year' => '1997',
                                'image' => 'assets/img/institutions.png',
                                        ...
                                        <div class="card-body">
                                            <div class="row apoicons">
                                                ...
                                                <div class="col-6 col-sm-6 mb-3">
                                                    <div class="row text-secondary align-items-center">
                                                        <div class="col-3 pr-0">
                                                            <img class="img-fluid" src="<?= base_url('assets/images/icons/est-icon.jpg') ?>">
                                                        </div>
                                                ...
                                                <div class="col-6 col-sm-6 mb-3">
                                                    <div class="row text-secondary align-items-center">
                                                        <div class="col-3 pr-0">
                                                            <img class="img-fluid" src="<?= base_url('assets/images/icons/church-icon.jpg') ?>">
                                                        </div>
                                                ...
                                                <div class="col-12 col-sm-6 mb-3">
                                                    <div class="row text-secondary">
                                                        <div class="col-3 pr-0">
                                                            <img class="img-fluid" src="<?= base_url('assets/images/icons/place-icon.jpg') ?>">
                                                        </div>
                                                        <div class="col-9">
                                                ...
                                                <div class="col-12 col-sm-6 mb-3">
                                                    <div class="row text-secondary align-items-center">
                                                        <div class="col-3 pr-0">
                                                            <img class="img-fluid" src="<?= base_url('assets/images/icons/vicar-icon.jpg') ?>">
                                                        </div>
                                                        <div class="col-9">
                                                ...
                                                <div class="col-12 col-sm-6 mb-3">
                                                    <div class="row text-secondary align-items-center">
                                                        <div class="col-3 pr-0">
                                                            <img class="img-fluid" src="<?= base_url('assets/images/icons/managment-icon2.jpg') ?>">
                                                        </div>
                                                ...
                                                <div class="col-12 col-sm-6 mb-3">
                                                    <div class="row text-secondary align-items-center">
                                                        <div class="col-3 pr-0">
                                                            <img class="img-fluid" src="<?= base_url('assets/images/icons/phone-icon.jpg') ?>">
                                                        </div>
                                                        <div class="col-9">
                    ...
                    <div class="tab-pane fade" id="btech" role="tabpanel" aria-labelledby="btech-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="academic_card">
                                    <img src="https://mananthavadydiocese.com/uploads/posts/1684397167.png" class="img-fluid" alt="Parish church">
                                </div>
                        ...
                        $upperschools = [
                            [
                                ...
                                'year' => '1998',
                                'image' => 'assets/images/education/Carmel-Integrate-school2.jpg',
                                'place' => 'Warangal',
                    ...
                    <div class="tab-pane fade" id="mtech" role="tabpanel" aria-labelledby="mtech-tab">
                        ...
                        <div class="card mb-4" data-aos="fade-up"
                            ...
                            <div class="row no-gutters align-items-stretch" id="schoolCard">
                                ...
                                <div class="col-lg-4 col-md-12 transition-col" id="imageCol">
                                    <img src="<?= base_url('assets/images/education/Assisi-high-school2.jpg') ?>" class="img-fluid h-100 w-100" alt="Parish church" style="object-fit: cover;">
                                </div>
                                ...
                                <div class="col-lg-8 col-md-12 transition-col" id="infoCol">
                                    <div class="card-body">
                                        ...
                                        <div class="row apoicons">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <div class="row text-secondary align-items-center">
                                                    <div class="col-3 pr-0"><img class="img-fluid" src="<?= base_url('assets/images/icons/est-icon.jpg') ?>"></div>
                        ...
                        <div class="card mb-4" data-aos="fade-up"
                            ...
                            <div class="row no-gutters align-items-stretch" id="schoolCard">
                                <!-- Image Side -->
                                <div class="col-lg-4 col-md-12 transition-col" id="imageCol">
                                    <img src="<?= base_url('assets/images/education/BISHOP-BERETTA-E_M-HIGHS-CHOOL.jpg') ?>" class="img-fluid h-100 w-100" alt="Parish church" style="object-fit: cover;">
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row apoicons">
                                            ...
                                            <div class="col-sm-6 mb-4">
                                                <div class="row text-secondary align-items-center">
                                                    <!-- <div class="col-3 pr-0">
                                                        <img class="img-fluid" src="<?= base_url('assets/images/icons/mail-icon.jpg') ?>">
                                                    </div> -->
                                                    <div class="col-3 pr-0 text-center fs-4">
                                                        <i class="fas fa-building custom-icon"></i>
                                                    </div>
                        ...
                        <div class="card mb-4" data-aos="fade-up"
                            ...
                            <div class="row no-gutters align-items-stretch" id="schoolCard">
                                <!-- Image Side -->
                                <div class="col-lg-4 col-md-12 transition-col" id="imageCol">
                                    <img src="<?= base_url('assets/images/education/Carmel-Integrate-school2.jpg') ?>" class="img-fluid h-100 w-100" alt="Parish church" style="object-fit: cover;">
                                </div>
