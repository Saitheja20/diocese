  ...
  <script>
    const people = [
      { name: "Akhil", dob: "1996-08-29", img: "<?= base_url('assets/images/birthday/person1.png') ?>" },
      { name: "Sneha", dob: "2002-08-10", img: "<?= base_url('assets/images/birthday/person1.png') ?>" },
      { name: "Akhil", dob: "1996-08-28", img: "<?= base_url('assets/images/birthday/person2.png') ?>" },
      { name: "Sneha", dob: "2002-08-31", img: "<?= base_url('assets/images/birthday/person1.png') ?>" },
      { name: "Akhil", dob: "1996-08-30", img: "<?= base_url('assets/images/birthday/person2.png') ?>" },
      { name: "Sita", dob: "1990-01-05", img: "assets/images/birthday/person2.png" },
      { name: "Rahul", dob: "1989-01-21", img: "assets/images/birthday/person2.png" },
      { name: "Priya", dob: "1992-02-14", img: "assets/images/birthday/person2.png" },
      { name: "Vikram", dob: "1994-02-28", img: "assets/images/birthday/person2.png" }
    ];
