  ...
  <div class="row g-4">
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
      <div class="audio-thumbnail" data-bs-toggle="modal" data-bs-target="#audioModal">
        ...
        <audio class="song-audio" preload="none">
          <source src="<?= base_url('assets/') ?>Songs/vlog-beat-background-349853.mp3" type="audio/mpeg" />
        </audio>
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
      <div class="audio-thumbnail" data-bs-toggle="modal" data-bs-target="#audioModal">
        ...
        <div class="play-overlay"><i class="bi bi-music-note-beamed"></i></div>
        <audio class="song-audio" preload="none">
          <source src="<?= base_url('assets/') ?>Songs/emotional.mp3" type="audio/mpeg" />
        </audio>
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
      <div class="audio-thumbnail" data-bs-toggle="modal" data-bs-target="#audioModal">
        ...
        <div class="play-overlay"><i class="bi bi-music-note-beamed"></i></div>
        <audio class="song-audio" preload="none">
          <source src="assets/Songs/vlog-beat-background-349853.mp3" type="audio/mpeg" />
        </audio>
