  ...
  <div class="container">
    <div class="row mb-2">
      <div class="col-lg-3 text-center" style="width: 18rem;">
        <div class="card">
          <img class="card-img-top" src="<?= base_url('assets/images/bishops/b1.jpg') ?>" alt="Card image cap" height="200px">
          <div class="card-body">
      ...
      <div class="col-lg-3 text-center" style="width: 18rem;">
        <div class="card">
          <img class="card-img-top" src="<?= base_url('assets/images/bishops/b2.jpg') ?>" alt="Card image cap" height="200px">
          <div class="card-body">
      ...
      <div class="col-lg-3 text-center" style="width: 18rem;">
        <div class="card">
          <img class="card-img-top" src="<?= base_url('assets/images/bishops/udumula-bala.jpg') ?>" alt="Card image cap" height="200px">
          <div class="card-body">
    ...
    <div class="row justify-content-center g-4 my-4">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="card text-center">
          <img class="card-img-top" src="<?= base_url('assets/images/bishops/udumula-bala.jpg') ?>" alt="Bishop Image">
          <div class="card-body">
            <p class="card-text">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="card text-center">
          <img class="card-img-top" src="<?= base_url('assets/images/bishops/b1.jpg') ?>" alt="Chancellor Image">
          <div class="card-body">
            <p class="card-text">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="card text-center">
          <img class="card-img-top" src="<?= base_url('assets/images/bishops/b2.jpg') ?>" alt="Secretary Image">
          <div class="card-body">
            <p class="card-text">
