<section id="news-letters">
    <div class="container">
        ...
        foreach ($months2025 as $data):
            $month = $data['month'];
            $image = $data['image'];
            $pdfUrl = base_url("assets/pdf/news-letters/2024/Fatima-Vani-{$month}-2025.pdf");
            $imageUrl = base_url("assets/images/news-letters/{$image}");
        ?>
        ...
        foreach ($months2024 as $data):
            $month = $data['month'];
            $image = $data['image'];
            $pdfUrl = base_url("assets/pdf/news-letters/2024/Fatima-Vani-{$month}-2024.pdf");
            $imageUrl = base_url("assets/images/news-letters/{$image}");
        ?>
            <div class="row" data-aos="fade-up"
                data-aos-anchor-placement="center-bottom"
        ...
        foreach ($months as $data):
            ...
            $year = $data['year'];
            $image = $data['image'];
            $pdfUrl = base_url("assets/pdfs/news-letters/Fatima-Vani-{$month}-{$year}.pdf");
            $imageUrl = base_url("assets/images/news-letters/{$image}");
        ?>
            <div class="row" data-aos="fade-up"
                data-aos-anchor-placement="center-bottom"
